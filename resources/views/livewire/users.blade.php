<div class="flex justify-center gap-10">
  <div class="w-1/3 my-5">
    <div class="flex flex-col justify-center">
      <div>
        <h2 class="mt-5 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Create New User</h2>
      </div>
      ...
      <div class="mt-4">
        <form wire:submit="createNewUser" action="#" method="POST" class="space-y-6">
          ...
          <div wire:loading wire:target="avatar"
            class="flex items-center justify-center w-20 h-20 border border-gray-200 rounded-md bg-gray-50">
            <div
              class="px-2 py-1 text-xs font-medium leading-none text-center text-blue-800 bg-blue-200 rounded-full animate-pulse">
              loading...</div>
          </div>
          ...
          @if ($avatar)
            <div>
              ...
              <img src="{{ $avatar->temporaryUrl() }}" alt="{{ $name }}"
          ...
          <div>
            <button type="submit"
              ...
              <svg wire:loading wire:target="createNewUser" aria-hidden="true"
                class="w-4 h-4 self-center mr-2 text-gray-200 animate-spin fill-blue-600" viewBox="0 0 100 101"
  ...
  <div class="w-1/3 my-10">
    ...
    <form wire:submit="search" class="mx-auto">
      ...
      <div class="relative">
        ...
        <input wire:model.live.debounce.250ms="query" type="search" id="query"
        ...
        <li class="flex items-center justify-between gap-x-6 py-5">
          <div class="flex min-w-0 gap-x-4">
            <img src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('img/default-avatar.png') }}"
              alt="{{ $user->name }}" class="size-12 flex-none rounded-full bg-gray-50" />
